...
public class Catapult extends Subsystem {
    ...
    public Catapult() {
        ...
        launcher = new DoubleSolenoid(0, 0, 7);
    ...
    public void setCatapult(boolean launched) {
        if (!Robot.intake.getIntakeDeployed()) {
            return;
        }
        launcher.set(launched ? Value.kReverse : Value.kForward);
    }

    public boolean getCatapultIsUp() {
        return launcher.get() == Value.kReverse;
    }
